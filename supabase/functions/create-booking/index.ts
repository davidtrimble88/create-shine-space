...
const BookingSchema = z.object({
  ...
  guardian_name: NullableString,
  guardian_relationship: NullableString,
  guardian_phone: NullableString,
  guardian_email: NullableString,
  rider_track: NullableString,
  bike_info: NullableString,
  roster_comment: NullableString,
