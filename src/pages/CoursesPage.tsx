...
const BasicCourse = () => (
  ...
  >
    ...
    <div className="bg-gradient-to-br from-accent/15 via-accent/8 to-transparent border-2 border-accent/30 rounded-3xl p-8 md:p-10 mb-12">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-card/80 backdrop-blur-sm border border-border rounded-2xl p-6">
          ...
          <p className="text-3xl font-bold text-accent mb-3"><EditableText contentKey="courses.mtc.priceAlt" fallback="$425" /><span className="text-muted-foreground ml-2 font-normal text-lg">(21+)</span></p>
    ...
    <IdRequirementNote className="mt-4" />
  </motion.div>
);
