...
export const CMSP_WAIVER_VERSION = "2026-04";

export const CMSP_WAIVER_TEXT = `TOTAL CONTROL TRAINING, INC. COURSE WAIVER AND INDEMNIFICATION
...
If I have brought a motorcycle/scooter/Personal Protective Equipment to use in the Motorcycle Rider Education Course, I also agree that this release applies to any damage that occurs to it during the Motorcycle Rider Education Course.

I HAVE READ THIS WAIVER AND RELEASE AGREEMENT AND BY SIGNING BELOW I AGREE IT IS MY INTENTION TO ASSUME ALL RISKS AND RELEASE THE ABOVE-NAMED MOTORCYCLE COURSE PROVIDERS FROM LIABILITY FOR PERSONAL INJURY, PROPERTY DAMAGE OR WRONGFUL DEATH CAUSED BY NEGLIGENCE OR ANY OTHER CAUSE. I fully understand and acknowledge this waiver and release section extends to the provisions of California Civil Code §1542, and to the similar laws of other states, military reservations, federal government, and/or jurisdictions where the Motorcycle Rider Education Course is offered, and consciously waive and release all unknown claims that may be later discovered. I have had the opportunity to ask any questions about the above waiver and release section, and I understand its purpose, terms, and meaning.

INDEMNIFICATION AND HOLD HARMLESS AGREEMENT: I, on behalf of myself, my personal representatives and my heirs, agree to hold harmless, defend, and indemnify the Motorcycle Course Providers from any and all claims, suits, or causes of action by others for bodily injury, property damage, or other damages which may arise out of my use of motorcycles and motorcycle equipment or my participation in the Motorcycle Rider Education Course activities, including claims arising from the Motorcycle Course Providers' or any other party's negligence. I accept legal responsibility for claims or lawsuits arising from my participation. I understand this waiver does not apply where my actions or failure to follow instructions damage course equipment or the assigned training motorcycle; in those circumstances I am responsible for repair costs.`;
...
export interface WaiverPrefill {
  ...
  licenseState?: string;
  isMinor: boolean;
  /** If true, the parent/legal guardian will sign in person at the first in person class. Skip guardian gating online. */
